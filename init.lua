...
-- move mouse cursor to next screen
if hscursor_jump_keys then
    spoon.ModalMgr.supervisor:bind(hscursor_jump_keys[1], hscursor_jump_keys[2], 'Jump cursor to next screen', function()
...
if spoon.WinWin then
    ...
    cmodal:bind('', 'U', 'Two-fifth Left of Screen', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("twoFifthLeft") end)
    cmodal:bind('', 'I', 'Three-fifth Left of Screen', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("threeFifthLeft") end)
    cmodal:bind('', 'O', 'Two-fifth Right of Screen', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("twoFifthRight") end)
    cmodal:bind('', 'P', 'Three-fifth Right of Screen', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("threeFifthRight") end)
