...
function obj:moveAndResize(option)
  ...
  if cwin then
    ...
    options = {
      ...
      twoFifthLeft = function() cwin:setFrame({ x = cres.x, y = cres.y, w = cres.w * 2 / 5, h = cres.h }) end,
      threeFifthLeft = function() cwin:setFrame({ x = cres.x, y = cres.y, w = cres.w * 3 / 5, h = cres.h }) end,
      twoFifthRight = function() cwin:setFrame({ x = cres.x + cres.w * 3 / 5, y = cres.y, w = cres.w * 2 / 5, h = cres.h }) end,
      threeFifthRight = function() cwin:setFrame({ x = cres.x + cres.w * 2 / 5, y = cres.y, w = cres.w * 3 / 5, h = cres.h }) end,
