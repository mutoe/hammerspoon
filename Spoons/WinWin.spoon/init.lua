...
-- `twoFifthLeft` `threeFifthLeft` `twoFifthRIght` `threeFifthRight`
-- `center`, `fullscreen`, `expand`, `shrink`.
...
function obj:moveAndResize(option)
    ...
    if cwin then
        ...
        elseif option == "twoFifthLeft" then
            cwin:setFrame({x=cres.x, y=cres.y, w=cres.w*2/5, h=cres.h})
        elseif option == "threeFifthLeft" then
            cwin:setFrame({x=cres.x, y=cres.y, w=cres.w*3/5, h=cres.h})
        elseif option == "twoFifthRight" then
            cwin:setFrame({x=cres.x+cres.w*3/5, y=cres.y, w=cres.w*2/5, h=cres.h})
        elseif option == "threeFifthRight" then
            cwin:setFrame({x=cres.x+cres.w*2/5, y=cres.y, w=cres.w*3/5, h=cres.h})
