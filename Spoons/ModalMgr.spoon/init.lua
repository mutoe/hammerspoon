...
cres = hs.screen.mainScreen():fullFrame()
local obj = {}
obj.__index = obj
...
obj.supervisor = nil
obj.framePadding = 24
obj.frameW = 480 - 2 * obj.framePadding
obj.frameH = cres.h * 0.6 - 2 * obj.framePadding
obj.frameX = (cres.w - obj.frameW) / 2 + obj.framePadding
obj.frameY = (cres.h - obj.frameH) / 2 + obj.framePadding
obj.cellHeight = 40
obj.columns = 1
...
function obj:init()
  ...
  obj.which_key[1] = {
    type = "rectangle",
    action = "fill",
    fillColor = { hex = "#222222", alpha = 0.9 },
...
function obj:toggleCheatsheet(iterList, force)
  if obj.which_key:isShowing() and not force then
    ...
    obj.which_key:frame({
      x = obj.frameX - obj.framePadding,
      y = obj.frameY - obj.framePadding,
      w = obj.frameW + obj.framePadding,
      h = obj.frameH + obj.framePadding,
    })
    local keys_pool = {}
    ...
    for idx, val in ipairs(keys_pool) do
      obj.which_key[idx + 1] = {
        ...
        textAlignment = "left",
        frame = {
          x = tostring(obj.framePadding / obj.frameW),
          y = tostring((obj.framePadding + (idx - 1) * obj.cellHeight) / obj.frameH),
          w = tostring(1),
          h = tostring(obj.cellHeight / obj.frameH)
        }
      }
    end
    obj.which_key:show()
